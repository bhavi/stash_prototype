class FileUploadsController < ApplicationController
  ...
  def destroy
    @file_upload.destroy
    respond_to do |format|
      format.html { redirect_to file_uploads_url, notice: 'FileUpload was successfully destroyed.' }
  ...
  private
    ...
    def file_upload_params
      params.require(:file_upload).permit(:upload_file_name, :upload_file_size, :upload_content_type, :resource_id)
    end
end
